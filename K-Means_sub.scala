...
*/
object KMeansCluster extends Serializable {
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
/*Step 7 - Set up The KMeans Algorithm, setK is the number of clusters
in this case 2 as we want to compare with Classification with this specific Dataset
SetSeed is just the random split, 1L is fine here
We then use this Algorithm to fit to the Data
*/
val KMeansAlgo = new KMeans().setK(2).setSeed(1L)
val KMeansModel = KMeansAlgo.fit(HiggsDataFinal)
